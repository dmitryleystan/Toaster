...
class CUser
{
	...
	function regusers($array, $gr)
	{
		$n = count($array);		// count of users to regestration
		if (empty($gr))			// if group wasn't chosen 
			...
			if ($n != 0)	
				for ($i = 0; $i < $n; $i++)
				{
					...
					if ($str[0] == '') // if this user is already in this group...
					{
	...
	function delusers($array)
	{
		...
		if ($n != 0)
		{
			...
			myerror('Ви не обрали жодного користувача..');	// you didn/t choice any users..				
		return 0;
	}
